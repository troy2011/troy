...
### コード ([server/routes/shipRoutes.js:172-212](server/routes/shipRoutes.js#L172-L212))
```javascript
...
### コード ([server/routes/shipRoutes.js:112-135](server/routes/shipRoutes.js#L112-L135), [server/routes/shipRoutes.js:244-258](server/routes/shipRoutes.js#L244-L258), [server/routes/shipRoutes.js:348-365](server/routes/shipRoutes.js#L348-L365))
...
**視界内の船を取得（geohashクエリ）** ([server/routes/shipRoutes.js:437-493](server/routes/shipRoutes.js#L437-L493)):
```javascript
// Geohashの範囲を計算
