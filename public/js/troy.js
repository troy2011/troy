...
const QUEST_CONTENT_MAP = {
    solo: {
        'ビリヤード': [
            [
                { name: '芯合わせ挑戦', detail: 'センターショットで的球を1回入れられたら成功' },
                { name: '止めの基礎', detail: 'ストップショットで白球を当てた場所に止められたら成功' },
                { name: '序盤採点', detail: 'ボーラード合計10点以上なら成功' }
            ],
            [
                { name: '芯合わせ二連', detail: 'センターショット連続2回成功で達成' },
                { name: '戻しの刻み', detail: 'ドローで白球を手前に戻す2回成功で達成' },
                { name: '中盤採点', detail: 'ボーラード合計25点以上なら成功' }
            ],
            [
                { name: '薄当て制御', detail: '薄当てで白球を中央付近に止める2回成功で達成' },
                { name: 'フォロー加工', detail: 'フォローで白球を奥に送る2回成功で達成' },
                { name: '上積み採点', detail: 'ボーラード合計45点以上なら成功' }
            ],
            [
                { name: '反射設計', detail: '1クッションバンク成功2回で達成' },
                { name: '連続加工', detail: 'センターショット連続3回成功で達成' },
                { name: '精密採点', detail: 'ボーラード合計65点以上なら成功' }
            ],
            [
                { name: '二枚反射', detail: '2クッションバンク成功1回で達成' },
                { name: 'ロング加工', detail: 'ロングショット成功2回で達成' },
                { name: '高品質採点', detail: 'ボーラード合計90点以上なら成功' }
            ],
            [
                { name: '精密連鎖', detail: 'センターショット連続4回成功で達成' },
                { name: '反射連鎖', detail: 'クッションバンク連続3回成功で達成' },
                { name: '最終採点', detail: 'ボーラード合計120点以上なら成功' }
            ]
        ],
        'カラオケ': [
            [
                { name: '完走挑戦', detail: 'シングル1曲を完走できれば成功' },
                { name: '採点起動', detail: 'シングルで採点結果を表示できれば成功' },
                { name: '序盤スコア', detail: 'シングルで70点以上なら成功' }
            ],
            [
                { name: '基礎スコア', detail: 'シングルで78点以上なら成功' },
                { name: 'リズム刻み', detail: 'シングルでコンボ10以上なら成功' },
                { name: '安定の土台', detail: 'シングルで安定度70%以上なら成功' }
            ],
            [
                { name: '中盤スコア', detail: 'シングルで85点以上なら成功' },
                { name: '抑揚の彫り', detail: 'シングルで抑揚75%以上なら成功' },
                { name: '連続刻み', detail: 'シングルでコンボ25以上なら成功' }
            ],
            [
                { name: '上昇スコア', detail: 'シングルで90点以上なら成功' },
                { name: '安定の上積み', detail: 'シングルで安定度82%以上なら成功' },
                { name: '長段コンボ', detail: 'シングルでコンボ35以上なら成功' }
            ],
            [
                { name: '高品質スコア', detail: 'シングルで94点以上なら成功' },
                { name: '抑揚仕上げ', detail: 'シングルで抑揚88%以上なら成功' },
                { name: '連続仕上げ', detail: 'シングルでコンボ45以上なら成功' }
            ],
            [
                { name: '完成スコア', detail: 'シングルで98点以上なら成功' },
                { name: '極限抑揚', detail: 'シングルで抑揚93%以上なら成功' },
                { name: '極限コンボ', detail: 'シングルでコンボ55以上なら成功' }
            ]
        ],
        'ダーツ': [
            [
                { name: '初投計測', detail: 'カウントアップで180点以上なら成功' },
                { name: '301完走', detail: '301を1ゲームでクリアできれば成功' },
                { name: '初クローズ', detail: 'クリケットで任意ナンバー1つクローズできれば成功' }
            ],
            [
                { name: '刻み計測', detail: 'カウントアップで260点以上なら成功' },
                { name: '301ダブル', detail: '301をダブルフィニッシュできれば成功' },
                { name: '二枚封鎖', detail: 'クリケットで2クローズ達成なら成功' }
            ],
            [
        ...
        'トランプ': [
            [
                { name: '起点の手札', detail: 'ポーカーでワンペア以上を1回成立できれば成功' },
                { name: '静かな勝負', detail: 'ブラックジャックで1勝できれば成功' },
                { name: '初上がり', detail: '大富豪で1回上がれたら成功' }
            ],
            [
                { name: '二枚の形', detail: 'ポーカーでツーペア以上を1回成立できれば成功' },
                { name: '21達成', detail: 'ブラックジャックで21を1回達成できれば成功' },
                { name: '上位着', detail: '大富豪で2位以内を1回取れれば成功' }
            ],
            [
        ...
        'その他': [
            [
                { name: '港の演習', detail: 'ボードゲームを1回プレイできれば成功' },
                { name: '小舟の試運転', detail: 'ミニゲームを1回クリアできれば成功' },
                { name: '黒ひげ試し', detail: '黒ひげでセーフ1回出せたら成功' }
            ],
            [
                { name: '港の勝利', detail: 'ボードゲームで1勝できれば成功' },
                { name: '潮流突破', detail: 'ミニゲームを時間内クリアできれば成功' },
                { name: '黒ひげ連続', detail: '黒ひげで連続セーフ2回出せたら成功' }
            ],
            [
