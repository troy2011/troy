    ...
    solo: {
        ...
        'ダーツ': [
            ...
            [
                ...
                { name: '獅子の咆哮', detail: 'ANIMAL BATTLE(vs CPU)でライオンに勝利できれば成功' }
            ]
        ],
        'トランプ': [
            [
