...
const QUEST_CONTENT_MAP = {
    solo: {
        'ビリヤード': [
            [
                { name: '芯合わせ挑戦', detail: 'センターショットで的球を2回入れられたら成功' },
                { name: '止めの基礎', detail: 'ストップショットで白球を当てた場所に2回止められたら成功' },
                { name: '序盤採点', detail: 'ボーラード合計20点以上なら成功' }
            ],
            [
                { name: '芯合わせ二連', detail: 'センターショット連続3回成功で達成' },
                { name: '戻しの刻み', detail: 'ドローで白球を手前に戻す3回成功で達成' },
                { name: '中盤採点', detail: 'ボーラード合計35点以上なら成功' }
            ],
            [
