    ...
    solo: {
        'ビリヤード': [
            [
                ...
                { name: 'ミニボーラード初級', detail: 'ミニボーラードで6個のボールを取り切れたら成功' },
                { name: 'フットショット初級', detail: 'フットショットを3回チャレンジして1回成功できれば達成' }
            ],
            [
                { name: 'センター精度', detail: 'センターショットを3回チャレンジして2回成功できれば達成' },
                { name: 'ヘッドショット初級', detail: 'ヘッドショットを3回チャレンジして1回成功できれば達成' },
                { name: 'サイド指定初級', detail: 'サイドポケット指定でセンターショットを3回チャレンジして1回成功できれば達成' }
            ],
            [
            ...
            [
                { name: 'サイド指定精度', detail: 'サイドポケット指定でセンターショットを3回チャレンジして2回成功できれば達成' },
                { name: 'バンクショット初級', detail: '1クッションバンクを3回チャレンジして1回成功できれば達成' },
                { name: 'ミニボーラード二連', detail: 'ミニボーラードで6個取り切りを2回連続で成功できれば達成' }
            ],
            [
                { name: 'サイド指定三連', detail: 'サイドポケット指定でセンターショットを3回チャレンジして全て成功できれば達成' },
                { name: 'バンクショット精度', detail: '1クッションバンクを3回チャレンジして2回成功できれば達成' },
                { name: 'ミニボーラード二連無傷', detail: 'ミニボーラードで6個取り切りを2回連続ノーミスで成功できれば達成' }
            ],
            [
                { name: 'バンクショット三連', detail: '1クッションバンクを3回チャレンジして全て成功できれば達成' },
                { name: 'フット&ヘッド三連', detail: 'フット→ヘッド→フットの順で3回チャレンジして全て成功できれば達成' },
        ...
        'ダーツ': [
            ...
            [
                ...
                { name: '701短縮', detail: '701を12ラウンド以内にクリアできれば成功' },
                { name: '01極短', detail: '01を10ラウンド以内にクリアできれば成功' }
            ],
            [
                { name: '最終計測', detail: 'カウントアップで520点以上なら成功' },
                { name: '701極短', detail: '701を10ラウンド以内にクリアできれば成功' },
                { name: '01極短・極', detail: '01を8ラウンド以内にクリアできれば成功' }
            ]
        ],
        'トランプ': [
            [
