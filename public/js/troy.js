    ...
    solo: {
        'ビリヤード': [
            [
                ...
                { name: '押し玉初級', detail: '押し玉(フォロー)でセンターショットを3回チャレンジして1回成功できれば達成' }
            ],
            [
                { name: 'センター精度', detail: 'センターショットを3回チャレンジして2回成功できれば達成' },
                { name: 'ミニボーラード安定', detail: 'ミニボーラードで6個のボールをミス1回以内で取り切れたら成功' },
                { name: '引き玉初級', detail: '引き玉(ドロー)でセンターショットを3回チャレンジして1回成功できれば達成' }
            ],
            [
                { name: '押し玉精度', detail: '押し玉(フォロー)でセンターショットを3回チャレンジして2回成功できれば達成' },
                { name: '引き玉精度', detail: '引き玉(ドロー)でセンターショットを3回チャレンジして2回成功できれば達成' },
