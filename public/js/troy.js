...
const QUEST_CONTENT_MAP = {
    solo: {
        'ビリヤード': [
            [
                { name: '9ボール初走', detail: '9ボールで1ラック完走できれば成功' },
                { name: '8ボール初走', detail: '8ボールで1ラック完走できれば成功' },
                { name: '序盤採点', detail: 'ボーラード合計30点以上なら成功' }
            ],
            [
                { name: '9ボール二走', detail: '9ボールで2ラック完走できれば成功' },
                { name: '8ボール二走', detail: '8ボールで2ラック完走できれば成功' },
                { name: '中盤採点', detail: 'ボーラード合計50点以上なら成功' }
            ],
            [
                { name: '9ボール連走', detail: '9ボールで1ラック完走を2回連続できれば成功' },
                { name: '8ボール連走', detail: '8ボールで1ラック完走を2回連続できれば成功' },
                { name: '上積み採点', detail: 'ボーラード合計70点以上なら成功' }
            ],
            [
                { name: '9ボール三走', detail: '9ボールで3ラック完走できれば成功' },
                { name: '8ボール三走', detail: '8ボールで3ラック完走できれば成功' },
                { name: '精密採点', detail: 'ボーラード合計90点以上なら成功' }
            ],
            [
                { name: '9ボール二連走', detail: '9ボールで2ラック連続完走できれば成功' },
                { name: '8ボール二連走', detail: '8ボールで2ラック連続完走できれば成功' },
                { name: '高品質採点', detail: 'ボーラード合計110点以上なら成功' }
            ],
            [
                { name: '9ボール三連走', detail: '9ボールで3ラック連続完走できれば成功' },
                { name: '8ボール三連走', detail: '8ボールで3ラック連続完走できれば成功' },
                { name: '最終採点', detail: 'ボーラード合計140点以上なら成功' }
            ]
        ],
        'カラオケ': [
            [
