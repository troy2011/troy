...
const MENU_IMAGE_RULES = [
    ...
    { pattern: /ハイボール|ウイスキー/u, image: drinkAsset('cocktail_amber_whiskey_tumbler.png') },
    ...
    { pattern: /カシス/u, image: drinkAsset('cocktail_grape_crush_highball.png') },
    ...
    { pattern: /焼酎.*(お茶|ウーロン)|お茶|ウーロン/u, image: drinkAsset('fantasy_green_ship_bottle.png') },
