...
const MAJOR_FORTUNE = {
    ...
    9: {
        upright: '一人時間が質を上げます。内省が大きなヒントに。',
    ...
    11: {
        ...
        reversed: '不均衡が出やすい日。感情より事実ベースで判断を。'
    },
    12: {
    ...
    14: {
        ...
        reversed: '極端に振れやすい日。中庸を意識すると安定します。'
    },
    15: {
    ...
    16: {
        ...
        reversed: '先延ばしの揺り戻しに注意。早めの修正で被害最小化。'
    },
    17: {
    ...
    18: {
        upright: '感受性が高い日。違和感を見逃さないことが成功の鍵。',
    ...
    21: {
        ...
        reversed: '詰めの甘さに注意。最終確認を徹底すると大成功に。'
    }
};
